...
#define TAGKEYS(KEY,TAG) \
	{ ALTKEY,                       KEY,      comboview,      {.ui = 1 << TAG} }, \
	{ ALTKEY|ControlMask,           KEY,      toggleview,     {.ui = 1 << TAG} }, \
	{ ALTKEY|ShiftMask,             KEY,      combotag,       {.ui = 1 << TAG} }, \
	{ ALTKEY|ControlMask|ShiftMask, KEY,      toggletag,      {.ui = 1 << TAG} }, \
	{ ALTKEY|METAKEY|ShiftMask,    KEY,      swaptags,       {.ui = 1 << TAG} }, \
	{ ALTKEY|METAKEY,              KEY,      tagnextmon,     {.ui = 1 << TAG} }, \
	{ ALTKEY|METAKEY|ControlMask,  KEY,      tagprevmon,     {.ui = 1 << TAG} },
...
static const Key keys[] = {
	/* modifier                     key            function                argument */
	#if KEYMODES_PATCH
	{ ALTKEY,                       XK_Escape,     setkeymode,             {.ui = COMMANDMODE} },
	#endif // KEYMODES_PATCH
	{ ALTKEY,                       XK_p,          spawn,                  {.v = dmenucmd } },
	{ ALTKEY|ShiftMask,             XK_Return,     spawn,                  {.v = termcmd } },
	#if RIODRAW_PATCH
	{ ALTKEY|ControlMask,           XK_p,          riospawnsync,           {.v = dmenucmd } },
	{ ALTKEY|ControlMask,           XK_Return,     riospawn,               {.v = termcmd } },
	{ ALTKEY,                       XK_s,          rioresize,              {0} },
	#endif // RIODRAW_PATCH
	{ ALTKEY,                       XK_b,          togglebar,              {0} },
	#if TOGGLETOPBAR_PATCH
	{ ALTKEY|ShiftMask,             XK_b,          toggletopbar,           {0} },
	#endif // TOGGLETOPBAR_PATCH
	#if TAB_PATCH
	{ ALTKEY|ControlMask,           XK_b,          tabmode,                {-1} },
	#endif // TAB_PATCH
	#if FOCUSMASTER_PATCH || FOCUSMASTER_RETURN_PATCH
	{ ALTKEY|ControlMask,           XK_space,      focusmaster,            {0} },
	...
	#endif // STACKER_PATCH
	#if FOCUSDIR_PATCH
	{ ALTKEY,                       XK_Left,       focusdir,               {.i = 0 } }, // left
	{ ALTKEY,                       XK_Right,      focusdir,               {.i = 1 } }, // right
	{ ALTKEY,                       XK_Up,         focusdir,               {.i = 2 } }, // up
	{ ALTKEY,                       XK_Down,       focusdir,               {.i = 3 } }, // down
	#endif // FOCUSDIR_PATCH
	#if PLACEDIR_PATCH
	{ ALTKEY|ControlMask,           XK_Left,       placedir,               {.i = 0 } }, // left
	{ ALTKEY|ControlMask,           XK_Right,      placedir,               {.i = 1 } }, // right
	{ ALTKEY|ControlMask,           XK_Up,         placedir,               {.i = 2 } }, // up
	{ ALTKEY|ControlMask,           XK_Down,       placedir,               {.i = 3 } }, // down
	#endif // PLACEDIR_PATCH
	#if SWAPFOCUS_PATCH && PERTAG_PATCH
	{ ALTKEY,                       XK_s,          swapfocus,              {.i = -1 } },
	#endif // SWAPFOCUS_PATCH
	#if SWITCHCOL_PATCH
	{ ALTKEY,                       XK_v,          switchcol,              {0} },
	#endif // SWITCHCOL_PATCH
	#if ROTATESTACK_PATCH
	{ ALTKEY|METAKEY,              XK_j,          rotatestack,            {.i = +1 } },
	{ ALTKEY|METAKEY,              XK_k,          rotatestack,            {.i = -1 } },
	#endif // ROTATESTACK_PATCH
	#if INPLACEROTATE_PATCH
	{ ALTKEY|METAKEY,              XK_j,          inplacerotate,          {.i = +2 } }, // same as rotatestack
	{ ALTKEY|METAKEY,              XK_k,          inplacerotate,          {.i = -2 } }, // same as reotatestack
	{ ALTKEY|METAKEY|ShiftMask,    XK_j,          inplacerotate,          {.i = +1} },
	{ ALTKEY|METAKEY|ShiftMask,    XK_k,          inplacerotate,          {.i = -1} },
	#endif // INPLACEROTATE_PATCH
	#if PUSH_PATCH || PUSH_NO_MASTER_PATCH
	{ ALTKEY|ControlMask,           XK_j,          pushdown,               {0} },
	{ ALTKEY|ControlMask,           XK_k,          pushup,                 {0} },
	#endif // PUSH_PATCH / PUSH_NO_MASTER_PATCH
	{ ALTKEY,                       XK_i,          incnmaster,             {.i = +1 } },
	{ ALTKEY,                       XK_d,          incnmaster,             {.i = -1 } },
	#if FLEXTILE_DELUXE_LAYOUT
	{ ALTKEY|ControlMask,           XK_i,          incnstack,              {.i = +1 } },
	{ ALTKEY|ControlMask,           XK_u,          incnstack,              {.i = -1 } },
	#endif // FLEXTILE_DELUXE_LAYOUT
	{ ALTKEY,                       XK_h,          setmfact,               {.f = -0.05} },
	{ ALTKEY,                       XK_l,          setmfact,               {.f = +0.05} },
	#if CFACTS_PATCH
	{ ALTKEY|ShiftMask,             XK_h,          setcfact,               {.f = +0.25} },
	{ ALTKEY|ShiftMask,             XK_l,          setcfact,               {.f = -0.25} },
	{ ALTKEY|ShiftMask,             XK_o,          setcfact,               {0} },
	#endif // CFACTS_PATCH
	#if ASPECTRESIZE_PATCH
	{ ALTKEY|ControlMask|ShiftMask, XK_e,          aspectresize,           {.i = +24} },
	{ ALTKEY|ControlMask|ShiftMask, XK_r,          aspectresize,           {.i = -24} },
	#endif // ASPECTRESIZE_PATCH
	#if MOVERESIZE_PATCH
	{ ALTKEY|METAKEY,              XK_Down,       moveresize,             {.v = "0x 25y 0w 0h" } },
	{ ALTKEY|METAKEY,              XK_Up,         moveresize,             {.v = "0x -25y 0w 0h" } },
	{ ALTKEY|METAKEY,              XK_Right,      moveresize,             {.v = "25x 0y 0w 0h" } },
	{ ALTKEY|METAKEY,              XK_Left,       moveresize,             {.v = "-25x 0y 0w 0h" } },
	{ ALTKEY|METAKEY|ShiftMask,    XK_Down,       moveresize,             {.v = "0x 0y 0w 25h" } },
	{ ALTKEY|METAKEY|ShiftMask,    XK_Up,         moveresize,             {.v = "0x 0y 0w -25h" } },
	{ ALTKEY|METAKEY|ShiftMask,    XK_Right,      moveresize,             {.v = "0x 0y 25w 0h" } },
	{ ALTKEY|METAKEY|ShiftMask,    XK_Left,       moveresize,             {.v = "0x 0y -25w 0h" } },
	...
	#if TRANSFER_PATCH
	{ ALTKEY,                       XK_x,          transfer,               {0} },
	#endif // TRANSFER_PATCH
	#if TRANSFER_ALL_PATCH
	{ ALTKEY|ControlMask,           XK_x,          transferall,            {0} },
	#endif // TRANSFER_ALL_PATCH
	#if REORGANIZETAGS_PATCH
	{ ALTKEY|ControlMask,           XK_r,          reorganizetags,         {0} },
	#endif // REORGANIZETAGS_PATCH
	#if DISTRIBUTETAGS_PATCH
	{ ALTKEY|ControlMask,           XK_d,          distributetags,         {0} },
	#endif // DISTRIBUTETAGS_PATCH
	#if INSETS_PATCH
	{ ALTKEY|ShiftMask|ControlMask, XK_a,          updateinset,            {.v = &default_inset } },
	#endif // INSETS_PATCH
	{ ALTKEY,                       XK_Return,     zoom,                   {0} },
	#if VANITYGAPS_PATCH
	{ ALTKEY|METAKEY,              XK_u,          incrgaps,               {.i = +1 } },
	{ ALTKEY|METAKEY|ShiftMask,    XK_u,          incrgaps,               {.i = -1 } },
	{ ALTKEY|METAKEY,              XK_i,          incrigaps,              {.i = +1 } },
	{ ALTKEY|METAKEY|ShiftMask,    XK_i,          incrigaps,              {.i = -1 } },
	{ ALTKEY|METAKEY,              XK_o,          incrogaps,              {.i = +1 } },
	{ ALTKEY|METAKEY|ShiftMask,    XK_o,          incrogaps,              {.i = -1 } },
	{ ALTKEY|METAKEY,              XK_6,          incrihgaps,             {.i = +1 } },
	{ ALTKEY|METAKEY|ShiftMask,    XK_6,          incrihgaps,             {.i = -1 } },
	{ ALTKEY|METAKEY,              XK_7,          incrivgaps,             {.i = +1 } },
	{ ALTKEY|METAKEY|ShiftMask,    XK_7,          incrivgaps,             {.i = -1 } },
	{ ALTKEY|METAKEY,              XK_8,          incrohgaps,             {.i = +1 } },
	{ ALTKEY|METAKEY|ShiftMask,    XK_8,          incrohgaps,             {.i = -1 } },
	{ ALTKEY|METAKEY,              XK_9,          incrovgaps,             {.i = +1 } },
	{ ALTKEY|METAKEY|ShiftMask,    XK_9,          incrovgaps,             {.i = -1 } },
	{ ALTKEY|METAKEY,              XK_0,          togglegaps,             {0} },
	{ ALTKEY|METAKEY|ShiftMask,    XK_0,          defaultgaps,            {0} },
	#endif // VANITYGAPS_PATCH
	#if ALT_TAB_PATCH
	...
	#endif // ALT_TAB_PATCH
	#if SHIFTTAG_PATCH
	{ ALTKEY|ShiftMask,             XK_Left,       shifttag,               { .i = -1 } }, // note keybinding conflict with focusadjacenttag tagtoleft
	{ ALTKEY|ShiftMask,             XK_Right,      shifttag,               { .i = +1 } }, // note keybinding conflict with focusadjacenttag tagtoright
	#endif // SHIFTTAG_PATCH
	#if SHIFTTAGCLIENTS_PATCH
	{ ALTKEY|ShiftMask|ControlMask, XK_Left,       shifttagclients,        { .i = -1 } },
	{ ALTKEY|ShiftMask|ControlMask, XK_Right,      shifttagclients,        { .i = +1 } },
	#endif // SHIFTTAGCLIENTS_PATCH
	#if SHIFTVIEW_PATCH
	{ ALTKEY|ShiftMask,             XK_Tab,        shiftview,              { .i = -1 } },
	{ ALTKEY|ShiftMask,             XK_backslash,  shiftview,              { .i = +1 } },
	#endif // SHIFTVIEW_PATCH
	#if SHIFTVIEW_CLIENTS_PATCH
	{ ALTKEY|METAKEY,              XK_Tab,        shiftviewclients,       { .i = -1 } },
	{ ALTKEY|METAKEY,              XK_backslash,  shiftviewclients,       { .i = +1 } },
	#endif // SHIFTVIEW_CLIENTS_PATCH
	#if SHIFTBOTH_PATCH
	{ ALTKEY|ControlMask,           XK_Left,       shiftboth,              { .i = -1 } }, // note keybinding conflict with focusadjacenttag tagandviewtoleft placedir
	{ ALTKEY|ControlMask,           XK_Right,      shiftboth,              { .i = +1 } }, // note keybinding conflict with focusadjacenttag tagandviewtoright placedir
	#endif // SHIFTBOTH_PATCH
	#if SHIFTSWAPTAGS_PATCH && SWAPTAGS_PATCH
	{ ALTKEY|METAKEY|ShiftMask,    XK_Left,       shiftswaptags,          { .i = -1 } },
	{ ALTKEY|METAKEY|ShiftMask,    XK_Right,      shiftswaptags,          { .i = +1 } },
	#endif // SHIFTSWAPTAGS_PATCH
	#if BAR_WINTITLEACTIONS_PATCH
	{ ALTKEY|ControlMask,           XK_z,          showhideclient,         {0} },
	{ ALTKEY|ControlMask,           XK_s,          unhideall,              {0} },
	#endif // BAR_WINTITLEACTIONS_PATCH
	{ ALTKEY|ShiftMask,             XK_c,          killclient,             {0} },
	#if KILLUNSEL_PATCH
	{ ALTKEY|ShiftMask,             XK_x,          killunsel,              {0} },
	#endif // KILLUNSEL_PATCH
	#if SELFRESTART_PATCH
	{ ALTKEY|ShiftMask,             XK_r,          self_restart,           {0} },
	#endif // SELFRESTART_PATCH
	{ ALTKEY|ShiftMask,             XK_q,          quit,                   {0} },
	#if RESTARTSIG_PATCH
	{ ALTKEY|ControlMask|ShiftMask, XK_q,          quit,                   {1} },
	#endif // RESTARTSIG_PATCH
	#if FOCUSURGENT_PATCH
	{ ALTKEY,                       XK_u,          focusurgent,            {0} },
	#endif // FOCUSURGENT_PATCH
	#if BAR_HOLDBAR_PATCH
	{ 0,                            HOLDKEY,       holdbar,                {0} },
	#endif // BAR_HOLDBAR_PATCH
	#if WINVIEW_PATCH
	{ ALTKEY,                       XK_o,          winview,                {0} },
	#endif // WINVIEW_PATCH
	#if XRDB_PATCH || XRESOURCES_PATCH
	{ ALTKEY|ShiftMask,             XK_F5,         xrdb,                   {.v = NULL } },
	...
	#if COLUMNS_LAYOUT
	{ ALTKEY,                       XK_c,          setlayout,              {.v = &layouts[3]} },
	#endif // COLUMNS_LAYOUT
	#if FLEXTILE_DELUXE_LAYOUT
	{ ALTKEY|ControlMask,           XK_t,          rotatelayoutaxis,       {.i = +1 } },   /* flextile, 1 = layout axis */
	{ ALTKEY|ControlMask,           XK_Tab,        rotatelayoutaxis,       {.i = +2 } },   /* flextile, 2 = master axis */
	{ ALTKEY|ControlMask|ShiftMask, XK_Tab,        rotatelayoutaxis,       {.i = +3 } },   /* flextile, 3 = stack axis */
	{ ALTKEY|ControlMask|ALTKEY,  XK_Tab,        rotatelayoutaxis,       {.i = +4 } },   /* flextile, 4 = secondary stack axis */
	{ ALTKEY|Mod5Mask,              XK_t,          rotatelayoutaxis,       {.i = -1 } },   /* flextile, 1 = layout axis */
	{ ALTKEY|Mod5Mask,              XK_Tab,        rotatelayoutaxis,       {.i = -2 } },   /* flextile, 2 = master axis */
	{ ALTKEY|Mod5Mask|ShiftMask,    XK_Tab,        rotatelayoutaxis,       {.i = -3 } },   /* flextile, 3 = stack axis */
	{ ALTKEY|Mod5Mask|ALTKEY,     XK_Tab,        rotatelayoutaxis,       {.i = -4 } },   /* flextile, 4 = secondary stack axis */
	{ ALTKEY|ControlMask,           XK_Return,     mirrorlayout,           {0} },          /* flextile, flip master and stack areas */
	#endif // FLEXTILE_DELUXE_LAYOUT
	...
	#endif // ALWAYSONTOP_PATCH
	#if MAXIMIZE_PATCH
	{ ALTKEY|ControlMask|ShiftMask, XK_h,          togglehorizontalmax,    {0} },
	{ ALTKEY|ControlMask|ShiftMask, XK_l,          togglehorizontalmax,    {0} },
	{ ALTKEY|ControlMask|ShiftMask, XK_j,          toggleverticalmax,      {0} },
	{ ALTKEY|ControlMask|ShiftMask, XK_k,          toggleverticalmax,      {0} },
	{ ALTKEY|ControlMask,           XK_m,          togglemax,              {0} },
	#endif // MAXIMIZE_PATCH
	#if NO_MOD_BUTTONS_PATCH
	{ ALTKEY|ShiftMask,             XK_Escape,     togglenomodbuttons,     {0} },
	#endif // NO_MOD_BUTTONS_PATCH
	#if RENAMED_SCRATCHPADS_PATCH
	{ ALTKEY,                       XK_grave,      togglescratch,          {.v = scratchpadcmd } },
	{ ALTKEY|ControlMask,           XK_grave,      setscratch,             {.v = scratchpadcmd } },
	{ ALTKEY|ShiftMask,             XK_grave,      removescratch,          {.v = scratchpadcmd } },
	#elif SCRATCHPADS_PATCH
	{ ALTKEY,                       XK_grave,      togglescratch,          {.ui = 0 } },
	{ ALTKEY|ControlMask,           XK_grave,      setscratch,             {.ui = 0 } },
	{ ALTKEY|ShiftMask,             XK_grave,      removescratch,          {.ui = 0 } },
	#endif // SCRATCHPADS_PATCH | RENAMED_SCRATCHPADS_PATCH
	#if UNFLOATVISIBLE_PATCH
	{ ALTKEY|METAKEY,              XK_space,      unfloatvisible,         {0} },
	{ ALTKEY|ShiftMask,             XK_t,          unfloatvisible,         {.v = &layouts[0]} },
	#endif // UNFLOATVISIBLE_PATCH
	#if TOGGLEFULLSCREEN_PATCH
	{ ALTKEY,                       XK_y,          togglefullscreen,       {0} },
	#endif // TOGGLEFULLSCREEN_PATCH
	#if !FAKEFULLSCREEN_PATCH && FAKEFULLSCREEN_CLIENT_PATCH
	{ ALTKEY|ShiftMask,             XK_y,          togglefakefullscreen,   {0} },
	#endif // FAKEFULLSCREEN_CLIENT_PATCH
	#if FULLSCREEN_PATCH
	{ ALTKEY|ShiftMask,             XK_f,          fullscreen,             {0} },
	#endif // FULLSCREEN_PATCH
	#if STICKY_PATCH
	{ ALTKEY|ShiftMask,             XK_s,          togglesticky,           {0} },
	#endif // STICKY_PATCH
	#if SCRATCHPAD_ALT_1_PATCH
	{ ALTKEY,                       XK_minus,      scratchpad_show,        {0} },
	{ ALTKEY|ShiftMask,             XK_minus,      scratchpad_hide,        {0} },
	{ ALTKEY,                       XK_equal,      scratchpad_remove,      {0} },
	#elif SCRATCHPADS_PATCH && !RENAMED_SCRATCHPADS_PATCH
	{ ALTKEY,                       XK_0,          view,                   {.ui = ~SPTAGMASK } },
	{ ALTKEY|ShiftMask,             XK_0,          tag,                    {.ui = ~SPTAGMASK } },
	#else
	...
	{ ALTKEY,                       XK_Left,       viewtoleft,             {0} }, // note keybinding conflict with focusdir
	{ ALTKEY,                       XK_Right,      viewtoright,            {0} }, // note keybinding conflict with focusdir
	{ ALTKEY|ShiftMask,             XK_Left,       tagtoleft,              {0} }, // note keybinding conflict with shifttag
	{ ALTKEY|ShiftMask,             XK_Right,      tagtoright,             {0} }, // note keybinding conflict with shifttag
	{ ALTKEY|ControlMask,           XK_Left,       tagandviewtoleft,       {0} }, // note keybinding conflict with placedir
	{ ALTKEY|ControlMask,           XK_Right,      tagandviewtoright,      {0} }, // note keybinding conflict with placedir
	#endif // FOCUSADJACENTTAG_PATCH
	#if TAGALL_PATCH
	{ ALTKEY|ShiftMask,             XK_F1,         tagall,                 {.v = "F1"} },
	{ ALTKEY|ShiftMask,             XK_F2,         tagall,                 {.v = "F2"} },
	{ ALTKEY|ShiftMask,             XK_F3,         tagall,                 {.v = "F3"} },
	{ ALTKEY|ShiftMask,             XK_F4,         tagall,                 {.v = "F4"} },
	{ ALTKEY|ShiftMask,             XK_F5,         tagall,                 {.v = "F5"} },
	{ ALTKEY|ShiftMask,             XK_F6,         tagall,                 {.v = "F6"} },
	{ ALTKEY|ShiftMask,             XK_F7,         tagall,                 {.v = "F7"} },
	{ ALTKEY|ShiftMask,             XK_F8,         tagall,                 {.v = "F8"} },
	{ ALTKEY|ShiftMask,             XK_F9,         tagall,                 {.v = "F9"} },
	{ ALTKEY|ControlMask,           XK_F1,         tagall,                 {.v = "1"} },
	{ ALTKEY|ControlMask,           XK_F2,         tagall,                 {.v = "2"} },
	{ ALTKEY|ControlMask,           XK_F3,         tagall,                 {.v = "3"} },
	{ ALTKEY|ControlMask,           XK_F4,         tagall,                 {.v = "4"} },
	{ ALTKEY|ControlMask,           XK_F5,         tagall,                 {.v = "5"} },
	{ ALTKEY|ControlMask,           XK_F6,         tagall,                 {.v = "6"} },
	{ ALTKEY|ControlMask,           XK_F7,         tagall,                 {.v = "7"} },
	{ ALTKEY|ControlMask,           XK_F8,         tagall,                 {.v = "8"} },
	{ ALTKEY|ControlMask,           XK_F9,         tagall,                 {.v = "9"} },
	#endif // TAGALL_PATCH
	#if TAGALLMON_PATCH
	{ ALTKEY|METAKEY|ShiftMask,    XK_comma,      tagallmon,              {.i = +1 } },
	{ ALTKEY|METAKEY|ShiftMask,    XK_period,     tagallmon,              {.i = -1 } },
	#endif // TAGALLMON_PATCH
	#if TAGSWAPMON_PATCH
	{ ALTKEY|METAKEY|ControlMask,  XK_comma,      tagswapmon,             {.i = +1 } },
	{ ALTKEY|METAKEY|ControlMask,  XK_period,     tagswapmon,             {.i = -1 } },
	#endif // TAGSWAPMON_PATCH
	#if BAR_ALTERNATIVE_TAGS_PATCH
	{ ALTKEY,                       XK_n,          togglealttag,           {0} },
	#endif // BAR_ALTERNATIVE_TAGS_PATCH
	#if NAMETAG_PATCH
	{ ALTKEY|ShiftMask,             XK_n,          nametag,                {0} },
	#endif // NAMETAG_PATCH
	#if BAR_TAGGRID_PATCH
	{ ALTKEY|ControlMask,           XK_Up,         switchtag,              { .ui = SWITCHTAG_UP    | SWITCHTAG_VIEW } },
	{ ALTKEY|ControlMask,           XK_Down,       switchtag,              { .ui = SWITCHTAG_DOWN  | SWITCHTAG_VIEW } },
	{ ALTKEY|ControlMask,           XK_Right,      switchtag,              { .ui = SWITCHTAG_RIGHT | SWITCHTAG_VIEW } }, // note keybinding conflict with placedir
	{ ALTKEY|ControlMask,           XK_Left,       switchtag,              { .ui = SWITCHTAG_LEFT  | SWITCHTAG_VIEW } }, // note keybinding conflict with placedir
	{ ALTKEY|METAKEY,              XK_Up,         switchtag,              { .ui = SWITCHTAG_UP    | SWITCHTAG_TAG | SWITCHTAG_VIEW } },
	{ ALTKEY|METAKEY,              XK_Down,       switchtag,              { .ui = SWITCHTAG_DOWN  | SWITCHTAG_TAG | SWITCHTAG_VIEW } },
	{ ALTKEY|METAKEY,              XK_Right,      switchtag,              { .ui = SWITCHTAG_RIGHT | SWITCHTAG_TAG | SWITCHTAG_VIEW } },
	{ ALTKEY|METAKEY,              XK_Left,       switchtag,              { .ui = SWITCHTAG_LEFT  | SWITCHTAG_TAG | SWITCHTAG_VIEW } },
	#endif // BAR_TAGGRID_PATCH
	#if MOVECENTER_PATCH
	{ ALTKEY,                       XK_x,          movecenter,             {0} }, // note keybinding conflict with killunsel
	#endif // MOVECENTER_PATCH
	#if MOVEPLACE_PATCH
	{ ALTKEY,                       XK_KP_7,       moveplace,              {.ui = WIN_NW }},   /* XK_KP_Home,  */
	{ ALTKEY,                       XK_KP_8,       moveplace,              {.ui = WIN_N  }},   /* XK_KP_Up,    */
	{ ALTKEY,                       XK_KP_9,       moveplace,              {.ui = WIN_NE }},   /* XK_KP_Prior, */
	{ ALTKEY,                       XK_KP_4,       moveplace,              {.ui = WIN_W  }},   /* XK_KP_Left,  */
	{ ALTKEY,                       XK_KP_5,       moveplace,              {.ui = WIN_C  }},   /* XK_KP_Begin, */
	{ ALTKEY,                       XK_KP_6,       moveplace,              {.ui = WIN_E  }},   /* XK_KP_Right, */
	{ ALTKEY,                       XK_KP_1,       moveplace,              {.ui = WIN_SW }},   /* XK_KP_End,   */
	{ ALTKEY,                       XK_KP_2,       moveplace,              {.ui = WIN_S  }},   /* XK_KP_Down,  */
	{ ALTKEY,                       XK_KP_3,       moveplace,              {.ui = WIN_SE }},   /* XK_KP_Next,  */
	#endif // MOVEPLACE_PATCH
	#if EXRESIZE_PATCH
	{ ALTKEY,                       XK_KP_7,       explace,                {.ui = EX_NW }},   /* XK_KP_Home,  */
	{ ALTKEY,                       XK_KP_8,       explace,                {.ui = EX_N  }},   /* XK_KP_Up,    */
	{ ALTKEY,                       XK_KP_9,       explace,                {.ui = EX_NE }},   /* XK_KP_Prior, */
	{ ALTKEY,                       XK_KP_4,       explace,                {.ui = EX_W  }},   /* XK_KP_Left,  */
	{ ALTKEY,                       XK_KP_5,       explace,                {.ui = EX_C  }},   /* XK_KP_Begin, */
	{ ALTKEY,                       XK_KP_6,       explace,                {.ui = EX_E  }},   /* XK_KP_Right, */
	{ ALTKEY,                       XK_KP_1,       explace,                {.ui = EX_SW }},   /* XK_KP_End,   */
	{ ALTKEY,                       XK_KP_2,       explace,                {.ui = EX_S  }},   /* XK_KP_Down,  */
	{ ALTKEY,                       XK_KP_3,       explace,                {.ui = EX_SE }},   /* XK_KP_Next,  */

	{ ALTKEY|ShiftMask,             XK_KP_8,       exresize,               {.v = (int []){   0,  25 }}},  /* XK_KP_Up,    */
	{ ALTKEY|ShiftMask,             XK_KP_2,       exresize,               {.v = (int []){   0, -25 }}},  /* XK_KP_Down,  */
	{ ALTKEY|ShiftMask,             XK_KP_6,       exresize,               {.v = (int []){  25,   0 }}},  /* XK_KP_Right, */
	{ ALTKEY|ShiftMask,             XK_KP_4,       exresize,               {.v = (int []){ -25,   0 }}},  /* XK_KP_Left,  */
	{ ALTKEY|ShiftMask,             XK_KP_5,       exresize,               {.v = (int []){  25,  25 }}},  /* XK_KP_Begin, */
	{ ALTKEY|ShiftMask|ControlMask, XK_KP_5,       exresize,               {.v = (int []){ -25, -25 }}},  /* XK_KP_Begin, */

	{ ALTKEY|ControlMask,           XK_KP_6,       togglehorizontalexpand, {.i = +1} },  /* XK_KP_Right, */
	{ ALTKEY|ControlMask,           XK_KP_3,       togglehorizontalexpand, {.i =  0} },  /* XK_KP_Next,  */
	{ ALTKEY|ControlMask,           XK_KP_4,       togglehorizontalexpand, {.i = -1} },  /* XK_KP_Left,  */
	{ ALTKEY|ControlMask,           XK_KP_8,       toggleverticalexpand,   {.i = +1} },  /* XK_KP_Up,    */
	{ ALTKEY|ControlMask,           XK_KP_1,       toggleverticalexpand,   {.i =  0} },  /* XK_KP_End,   */
	{ ALTKEY|ControlMask,           XK_KP_2,       toggleverticalexpand,   {.i = -1} },  /* XK_KP_Down,  */
	{ ALTKEY|ControlMask,           XK_KP_9,       togglemaximize,         {.i = -1} },  /* XK_KP_Prior, */
	{ ALTKEY|ControlMask,           XK_KP_7,       togglemaximize,         {.i = +1} },  /* XK_KP_Home,  */
	{ ALTKEY|ControlMask,           XK_KP_5,       togglemaximize,         {.i =  0} },  /* XK_KP_Begin, */
	...
	{ Mod3Mask|ALTKEY,            XK_u,            floatpos,               {.v = "-1p -1p" } }, // ↖
	{ Mod3Mask|ALTKEY,            XK_i,            floatpos,               {.v = " 0p -1p" } }, // ↑
	{ Mod3Mask|ALTKEY,            XK_o,            floatpos,               {.v = " 1p -1p" } }, // ↗
	{ Mod3Mask|ALTKEY,            XK_j,            floatpos,               {.v = "-1p  0p" } }, // ←
	{ Mod3Mask|ALTKEY,            XK_k,            floatpos,               {.v = " 0p  0p" } }, // ·
	{ Mod3Mask|ALTKEY,            XK_l,            floatpos,               {.v = " 1p  0p" } }, // →
	{ Mod3Mask|ALTKEY,            XK_m,            floatpos,               {.v = "-1p  1p" } }, // ↙
	{ Mod3Mask|ALTKEY,            XK_comma,        floatpos,               {.v = " 0p  1p" } }, // ↓
	{ Mod3Mask|ALTKEY,            XK_period,       floatpos,               {.v = " 1p  1p" } }, // ↘
	#endif // FLOATPOS_PATCH
	#if SETBORDERPX_PATCH
	{ ALTKEY|ControlMask,           XK_minus,      setborderpx,            {.i = -1 } },
	{ ALTKEY|ControlMask,           XK_plus,       setborderpx,            {.i = +1 } },
	{ ALTKEY|ControlMask,           XK_numbersign, setborderpx,            {.i = 0 } },
	...
	#if MPDCONTROL_PATCH
	{ ALTKEY,                       XK_F1,         mpdchange,              {.i = -1} },
	{ ALTKEY,                       XK_F2,         mpdchange,              {.i = +1} },
	{ ALTKEY,                       XK_Escape,     mpdcontrol,             {0} },
...
static const Button buttons[] = {
	...
	#if TAPRESIZE_PATCH
	{ ClkClientWin,         ALTKEY,              Button4,        resizemousescroll, {.v = &scrollargs[0]} },
	{ ClkClientWin,         ALTKEY,              Button5,        resizemousescroll, {.v = &scrollargs[1]} },
	{ ClkClientWin,         ALTKEY,              Button6,        resizemousescroll, {.v = &scrollargs[2]} },
	{ ClkClientWin,         ALTKEY,              Button7,        resizemousescroll, {.v = &scrollargs[3]} },
	#endif // TAPRESIZE_PATCH
	#if DRAGCFACT_PATCH && CFACTS_PATCH
	{ ClkClientWin,         ALTKEY|ShiftMask,    Button3,        dragcfact,      {0} },
	#endif // DRAGCFACT_PATCH
	#if DRAGMFACT_PATCH
	{ ClkClientWin,         ALTKEY|ShiftMask,    Button1,        dragmfact,      {0} },
	#endif // DRAGMFACT_PATCH
